...
# Cargo crates to download before compilation (read from xidlehook Cargo.lock)
CRATES="
aho-corasick@0.7.15
ansi_term@0.11.0
async-channel@1.6.1
...
https://gitlab.com/jD91mZM2/xidlehook/-/archive/${PV}/xidlehook-${PV}.tar.bz2"
...
src_configure() {
	...
	cargo_src_configure --no-default-features --bins
}
